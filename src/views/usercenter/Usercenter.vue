      ...
      <el-col :span="3">
        <el-card class="card_left">
          ...
          <div class="router">
            ...
            /
            <span class="router_personal">个人中心</span>
          </div>
          <div class="menuconta">
            <el-menu :default-active="activeIndex" active-text-color="#ffd04b" background-color="#05c160" class="el-menu-vertical-demo" text-color="#fff" router>
              <el-menu-item index="/usercenter/picture">
                <el-icon><icon-ep-picture-filled /></el-icon>
                <span>图片资料</span>
              </el-menu-item>
              <el-menu-item index="/usercenter/movie">
                <el-icon><icon-ep-video-camera-filled /></el-icon>
                <span>视频资料</span>
              </el-menu-item>
              <el-menu-item index="/usercenter/group">
                <el-icon><icon-ep-user /></el-icon>
                <span>受害者群</span>
              </el-menu-item>
              <el-menu-item index="/usercenter/activity">
                <el-icon><icon-ep-bicycle /></el-icon>
                <span>组织活动</span>
              </el-menu-item>
              <el-menu-item index="/usercenter/crowdfunding">
                <el-icon><icon-ep-ticket /></el-icon>
                <span>资金众筹</span>
              </el-menu-item>
              <el-menu-item index="/usercenter/notice">
